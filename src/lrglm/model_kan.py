...
class LogisticRegressionKANModel(L.LightningModule):
    def __init__(
        self,
        input_dim,
        latent_dim,
        ...
        self.encoder = nn.Sequential(
            ...
            kan.MultKAN(width=[latent_dim, latent_dim], auto_save=False, **kan_kwargs),
        )
        ...
        for task_num, task_id in enumerate(self.task_ids):
            self.decoder.append(nn.Linear(latent_dim, output_dim, bias=self.bias))
